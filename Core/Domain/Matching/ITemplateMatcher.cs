...
namespace AutomationCore.Core.Abstractions
{
    ...
    public sealed class TemplateChangedEventArgs : EventArgs
    {
        ...
        public string? OldKey { get; init; } // Для случая Renamed
        public DateTime Timestamp { get; init; } = DateTime.UtcNow;

        public static TemplateChangedEventArgs Created(string key) => new() { Key = key, ChangeType = TemplateChangeType.Created };
        public static TemplateChangedEventArgs Modified(string key) => new() { Key = key, ChangeType = TemplateChangeType.Modified };
        public static TemplateChangedEventArgs Deleted(string key) => new() { Key = key, ChangeType = TemplateChangeType.Deleted };
        public static TemplateChangedEventArgs Renamed(string newKey, string oldKey) => new() { Key = newKey, OldKey = oldKey, ChangeType = TemplateChangeType.Renamed };
    }
