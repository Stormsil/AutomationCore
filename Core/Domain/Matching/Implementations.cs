...
namespace AutomationCore.Core.Matching
{
    ...
    {
        public Task<Mat> ProcessAsync(Mat src, PreprocessingOptions o)
        {
    ...
    {
        public Task<MatchResult> FindBestMatchAsync(Mat sourceP, Mat templP, MatchOptions o)
        {
            ...
            var (minS, maxS, step0) = o?.ScaleRange ?? new ScaleRange(1.0, 1.0, 0.01);
